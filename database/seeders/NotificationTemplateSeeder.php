        ...
        return [
            ...
            [
                ...
                'body' => $this->emailShell('Booking Confirmed!', '#10B981',
                    '<p style="'.EmailTheme::INFO.'">Hello <strong style="color:#fff">{{ customer_name }}</strong>, your booking is confirmed.</p>'.

                    '{{ booking_details_block }}'.
                    '<p class="no-link" style="color:#FFFFFF;font-size:13px;font-style:italic;margin:8px 0 0">You\'re welcome to arrive up to {{ tolerance_minutes }} minutes early. Luggage is fully secured and you can access it 24/7.</p>'.

                    '<h2 style="'.EmailTheme::H2.'">Pay Station Information</h2>'.
                    '<div style="'.EmailTheme::INFO.'">'.
                    ...
                    '<h2 style="'.EmailTheme::H2.'">Entry Instructions</h2>'.
                    '{{ codes_block }}'.

                    '<h2 style="'.EmailTheme::H2.'">How to use lockers</h2>'.
                    '<div style="'.EmailTheme::INFO.'"><ol style="padding-left:20px;margin:8px 0">'.
                    ...
                    '<div style="text-align:center;margin:24px 0">'.EmailTheme::button('{{ directions_url }}', 'Get Directions').'</div>'.

                    '<div style="'.EmailTheme::INFO.';text-align:center;margin-top:24px;padding-top:16px;border-top:1px solid #2A2A2A">'.
                    '<p>You are all set!</p>'.
            ...
            [
                ...
                'body' => $this->emailShell('Rezervacija potvrđena!', '#10B981',
                    '<p style="'.EmailTheme::INFO.'">Zdravo <strong style="color:#fff">{{ customer_name }}</strong>, vaša rezervacija je potvrđena.</p>'.

                    '{{ booking_details_block }}'.
                    '<p class="no-link" style="color:#FFFFFF;font-size:13px;font-style:italic;margin:8px 0 0">Možete doći i do {{ tolerance_minutes }} minuta ranije. Prtljag je potpuno bezbedan i pristup imate 24/7.</p>'.

                    '<h2 style="'.EmailTheme::H2.'">Informacije o plaćanju</h2>'.
                    '<div style="'.EmailTheme::INFO.'">'.
                    ...
                    '<h2 style="'.EmailTheme::H2.'">Uputstva za ulaz</h2>'.
                    '{{ codes_block }}'.

                    '<h2 style="'.EmailTheme::H2.'">Kako se koriste ormarići</h2>'.
                    '<div style="'.EmailTheme::INFO.'"><ol style="padding-left:20px;margin:8px 0">'.
                    ...
                    '<div style="text-align:center;margin:24px 0">'.EmailTheme::button('{{ directions_url }}', 'Uputstva do nas').'</div>'.
            ...
            [
                ...
                'body' => $this->emailShell('New Booking', '#F59E0B',
                    ...
                    '</table></div>'.
                    '<div style="'.EmailTheme::INFO.';margin-top:14px"><p style="margin:0 0 6px;color:#A0A0A0;font-size:12px;text-transform:uppercase;letter-spacing:1px">Lockers</p>{{ admin_lockers_block }}</div>'),
            ],
            [
                ...
                'body' => $this->emailShell('Nova rezervacija', '#F59E0B',
                    ...
                    '</table></div>'.
                    '<div style="'.EmailTheme::INFO.';margin-top:14px"><p style="margin:0 0 6px;color:#A0A0A0;font-size:12px;text-transform:uppercase;letter-spacing:1px">Ormarići</p>{{ admin_lockers_block }}</div>'),
            ],
            ...
            [
                ...
                'body' => $this->emailShell('Booking Cancelled', '#6B7280',
                    '<p style="'.EmailTheme::INFO.'">Hi {{ customer_name }},</p>'.
                    '<p style="'.EmailTheme::INFO.'">Your booking at <strong style="color:#fff">{{ location_name }}</strong> for {{ check_in_full }} has been cancelled at your request. No charges have been made.</p>'.
                    '<p style="'.EmailTheme::INFO.'">We hope to see you next time you\'re in Belgrade. If you need to store luggage again, you can book in 60 seconds:</p>'.
                    '<div style="text-align:center;margin:20px 0">'.EmailTheme::button('{{ directions_url }}', 'Book again').'</div>'.
                    '<p style="'.EmailTheme::INFO.';text-align:center;margin-top:20px;color:#6B7280">— {{ site_name }}</p>'),
            ],
            [
                ...
                'body' => $this->emailShell('Rezervacija otkazana', '#6B7280',
                    '<p style="'.EmailTheme::INFO.'">Zdravo {{ customer_name }},</p>'.
                    '<p style="'.EmailTheme::INFO.'">Vaša rezervacija na <strong style="color:#fff">{{ location_name }}</strong> za {{ check_in_full }} je otkazana na vaš zahtev. Nema naplate.</p>'.
                    '<p style="'.EmailTheme::INFO.'">Nadamo se da se vidimo sledeći put kad budete u Beogradu. Ako vam ponovo zatreba odlaganje prtljaga, rezervišite za 60 sekundi:</p>'.
                    '<div style="text-align:center;margin:20px 0">'.EmailTheme::button('{{ directions_url }}', 'Rezerviši ponovo').'</div>'.
                    '<p style="'.EmailTheme::INFO.';text-align:center;margin-top:20px;color:#6B7280">— {{ site_name }}</p>'),
            ],
            ...
            [
                ...
                'body' => $this->emailShell('Booking Cancelled', '#EF4444',
                    '<p style="'.EmailTheme::INFO.'">Hi {{ customer_name }},</p>'.
                    '<p style="'.EmailTheme::INFO.'">We have cancelled your booking at <strong style="color:#fff">{{ location_name }}</strong> scheduled for {{ check_in_full }}. No charges have been made.</p>'.
                    '<p style="'.EmailTheme::INFO.'">If this was unexpected or you would like more details, please reach out to us — we\'re happy to help find another slot or location.</p>'.
            ...
            [
                ...
                'body' => $this->emailShell('Rezervacija otkazana', '#EF4444',
                    '<p style="'.EmailTheme::INFO.'">Zdravo {{ customer_name }},</p>'.
                    '<p style="'.EmailTheme::INFO.'">Otkazali smo vašu rezervaciju na <strong style="color:#fff">{{ location_name }}</strong> zakazanu za {{ check_in_full }}. Nema naplate.</p>'.
                    '<p style="'.EmailTheme::INFO.'">Ako je ovo neočekivano ili želite više detalja, javite nam se — drago nam je da pomognemo da nađemo drugi termin ili lokaciju.</p>'.
                    '<div style="text-align:center;margin:20px 0">'.
                    '<p style="margin:0;color:#fff;font-size:14px"><strong>{{ support_phone }}</strong></p>'.
                    '<p style="margin:6px 0 0"><a href="mailto:{{ support_email }}" style="color:#F59E0B">{{ support_email }}</a></p>'.
                    '</div>'.
            ...
            [
                ...
                'body' => $this->emailShell('Locker Removed', '#F59E0B',
                    '<p style="'.EmailTheme::INFO.'">Hi {{ customer_name }},</p>'.
                    '<p style="'.EmailTheme::INFO.'">We\'ve removed the following locker(s) from your booking at <strong style="color:#fff">{{ location_name }}</strong>:</p>'.
                    '{{ removed_lockers_block }}'.
                    '<p style="'.EmailTheme::INFO.'">Your remaining locker(s) are unchanged and still active. An updated confirmation with the current lockers and total follows in a separate email.</p>'.
                    '<div style="text-align:center;margin:20px 0">'.
                    '<p style="margin:0;color:#fff;font-size:14px"><strong>{{ support_phone }}</strong></p>'.
                    '<p style="margin:6px 0 0"><a href="mailto:{{ support_email }}" style="color:#F59E0B">{{ support_email }}</a></p>'.
                    '</div>'.
            ...
            [
                ...
                'body' => $this->emailShell('Loker uklonjen', '#F59E0B',
                    '<p style="'.EmailTheme::INFO.'">Zdravo {{ customer_name }},</p>'.
                    '<p style="'.EmailTheme::INFO.'">Uklonili smo sledeće lokere iz vaše rezervacije na <strong style="color:#fff">{{ location_name }}</strong>:</p>'.
                    '{{ removed_lockers_block }}'.
                    '<p style="'.EmailTheme::INFO.'">Preostali lokeri su nepromenjeni i i dalje aktivni. Ažurirana potvrda sa trenutnim lokerima i iznosom stiže u zasebnom mejlu.</p>'.
                    '<div style="text-align:center;margin:20px 0">'.
                    '<p style="margin:0;color:#fff;font-size:14px"><strong>{{ support_phone }}</strong></p>'.
                    '<p style="margin:6px 0 0"><a href="mailto:{{ support_email }}" style="color:#F59E0B">{{ support_email }}</a></p>'.
                    '</div>'.
            ...
            [
                ...
                'body' => $this->emailShell('Booking Cancelled', '#EF4444',
                    ...
                    '</table></div>'.
                    '<p style="'.EmailTheme::INFO.';margin-top:12px;font-size:12px">TTLock passcode has been removed from the lock. Customer has been notified.</p>'),
            ],
            ...
            [
                ...
                'body' => $this->emailShell('PIN Reissued', '#F59E0B',
                    ...
                    '<tr><td style="padding:6px 0;color:#A0A0A0">Period</td><td style="padding:6px 0;color:#fff"><span class="no-link">{{ check_in_full }} → {{ check_out_full }}</span></td></tr>'.
                    '</table></div>'.
                    '<p style="'.EmailTheme::INFO.';margin-top:12px;font-size:12px">Old PIN was deleted from TTLock. New PIN is live on the lock. Customer has been notified.</p>'),
            ],
            ...
            [
                ...
                'body' => $this->emailShell('PIN Updated', '#F59E0B',
                    '<p style="'.EmailTheme::INFO.'">Hi <strong style="color:#fff">{{ customer_name }}</strong>,</p>'.
                    '<p style="'.EmailTheme::INFO.'">Your previous locker PIN is no longer valid. We have issued a new one — please use the access codes below from now on.</p>'.
                    '{{ booking_details_block }}'.
                    '<h2 style="'.EmailTheme::H2.'">Updated Access Codes</h2>'.
                    '{{ codes_block }}'.
                    '<p style="'.EmailTheme::INFO.';font-size:13px;font-style:italic;margin-top:12px">If you did not expect this change, please get in touch right away.</p>'.
                    '<div style="'.EmailTheme::INFO.';text-align:center;margin-top:24px;padding-top:16px;border-top:1px solid #2A2A2A">'.
            ...
            [
                ...
                'body' => $this->emailShell('PIN je promenjen', '#F59E0B',
                    '<p style="'.EmailTheme::INFO.'">Zdravo <strong style="color:#fff">{{ customer_name }}</strong>,</p>'.
                    '<p style="'.EmailTheme::INFO.'">Vaš prethodni PIN za ormarić više nije važeći. Izdali smo novi — molimo koristite šifre ispod od sada.</p>'.
                    '{{ booking_details_block }}'.
                    '<h2 style="'.EmailTheme::H2.'">Nove pristupne šifre</h2>'.
                    '{{ codes_block }}'.
                    '<p style="'.EmailTheme::INFO.';font-size:13px;font-style:italic;margin-top:12px">Ako niste očekivali ovu izmenu, molimo javite nam se odmah.</p>'.
                    '<div style="'.EmailTheme::INFO.';text-align:center;margin-top:24px;padding-top:16px;border-top:1px solid #2A2A2A">'.
                    '<p style="margin-top:8px"><a href="tel:{{ support_phone }}" style="color:#F59E0B;text-decoration:none;font-weight:bold">{{ support_phone }}</a> · <a href="mailto:{{ support_email }}" style="color:#F59E0B">{{ support_email }}</a></p>'.
                    '<p style="margin-top:16px;color:#6B7280">— {{ site_name }}</p>'.
                    '</div>'),
            ...
            [
                ...
                'body' => $this->emailShell('Thanks for stopping by! 🙌', '#F59E0B',
                    '<p style="'.EmailTheme::INFO.'">Hi {{ customer_name }},</p>'.
                    '<p style="'.EmailTheme::INFO.'">Thank you for storing your stuff with Belgrade Luggage Locker — we hope you had an awesome (and luggage-free) time in the city!</p>'.
                    '<p style="'.EmailTheme::INFO.'">If you were happy with our service, we\'d love a quick review:</p>'.
                    '<div style="text-align:center;margin:24px 0">'.
                    EmailTheme::button($reviewUrl, '⭐ Leave A Review').
                    '<p style="margin:12px 0 0;color:#6B7280;font-size:12px">Just one click — your review in less than 30 seconds :)</p>'.
                    '</div>'.
                    '<p style="'.EmailTheme::INFO.'">Your feedback helps other travelers find us — and totally makes our day!</p>'.
                    '<p style="'.EmailTheme::INFO.'">We appreciate your support! ❤️</p>'.
                    '<p style="'.EmailTheme::INFO.';text-align:center;margin-top:20px;color:#6B7280">The {{ site_name }} Team ✌️</p>'),
            ],
            [
                ...
                'body' => $this->emailShell('Hvala što ste svratili! 🙌', '#F59E0B',
                    '<p style="'.EmailTheme::INFO.'">Zdravo {{ customer_name }},</p>'.
                    '<p style="'.EmailTheme::INFO.'">Hvala što ste odložili stvari kod Belgrade Luggage Locker-a — nadamo se da ste imali sjajan (i bezbrižan) dan u gradu!</p>'.
                    '<p style="'.EmailTheme::INFO.'">Ako ste zadovoljni našom uslugom, ostavite nam kratku recenziju:</p>'.
                    '<div style="text-align:center;margin:24px 0">'.
                    EmailTheme::button($reviewUrl, '⭐ Ostavi recenziju').
                    '<p style="margin:12px 0 0;color:#6B7280;font-size:12px">Jedan klik — recenzija za manje od 30 sekundi :)</p>'.
                    '</div>'.
                    '<p style="'.EmailTheme::INFO.'">Vaš utisak pomaže drugim putnicima da nas pronađu — i mnogo nam znači!</p>'.
                    '<p style="'.EmailTheme::INFO.'">Hvala na podršci! ❤️</p>'.
                    '<p style="'.EmailTheme::INFO.';text-align:center;margin-top:20px;color:#6B7280">Tim {{ site_name }} ✌️</p>'),
            ],
        ];
    }

    /**
     * Document wrapper for every template.
     *
     * Delegates to {@see EmailTheme::shell()}, which puts the dark backgrounds
     * inline (and as `bgcolor` attributes) on the same elements that set the
     * light text colour. The previous version declared those backgrounds only
     * in a `<head><style>` block, so any client that strips `<style>` — Gmail
     * mobile web is the common one — rendered white-on-white and swallowed the
     * locker number, the customer name and the total.
     */
    private function emailShell(string $title, string $titleColor, string $inner): string
    {
        return EmailTheme::shell($title, $titleColor, $inner);
    }
}
