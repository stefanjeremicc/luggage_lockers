...
<section class="hero-section relative flex items-center justify-center overflow-hidden -mt-20">
    ...
    <div class="relative z-10 max-w-4xl mx-auto px-6 sm:px-6 lg:px-8 pt-24 pb-28 sm:pt-28 sm:pb-32 text-center">
        ...
        {{-- Social-proof tagline under the buttons (admin-editable, per-locale).
             Mobile: smaller font + no-wrap so it stays on ONE line; the checkmark
             is hidden below sm to free up the width it would otherwise take. --}}
        @if($heroTagline)
            <p class="mt-6 sm:mt-7 flex items-center justify-center gap-2 whitespace-nowrap text-xs sm:text-base font-medium text-white/70">
