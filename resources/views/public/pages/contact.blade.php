    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 mb-16">
            ...
            <div class="lg:col-span-2 flex flex-col gap-4">
                ...
                {{-- WhatsApp contact card hidden until Business API is wired up. --}}
                @endif
            ...
            <div class="lg:col-span-3">
                <div id="contact-map" class="contact-map h-[420px] lg:h-full lg:min-h-[420px] rounded-2xl border border-[#2A2A2A] overflow-hidden"></div>
            </div>
        </div>
